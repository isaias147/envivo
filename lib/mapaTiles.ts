...
//
// Oscura y minimalista (pega con el índigo de la app). Necesita una API key
// de Stadia en `NEXT_PUBLIC_STADIA_API_KEY` (.env.local y variables de
// entorno de Netlify). Tiene detalle nativo hasta zoom 20, así que no hace
// falta que Leaflet reescale tiles.
